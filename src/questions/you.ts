import type { Question, QuestionOption } from '../lib/types.ts';
import { POPULAR_MODEL_IDS } from './model-ids.ts';

// Add recommended flag to the first popular model for tier ceiling questions
...
export const YOU_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    when: { key: 'tierCeiling', isNot: 'deep' },
  },
  {
